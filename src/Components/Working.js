            ...
            <div className='Working_process_back'>
                <div className='Working_process'>
                    ...
                    <div className='Working_process_details'>
                        <div className='Working_process_details_title'>
                            Working Process
                        </div>
                        <div className='Working_process_details_discription1'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim exercitationem impedit iure quia quo recusandae?
                        </div>
                        <div className='Working_process_details_discription2'>
                            <span>Your Business Skills But Novor Stop Improving.
                                 <div className='Working_process_details_discription2_line'></div>
                            </span>
                        </div>
                        <div className='Working_process_details_discription3'>
                        ...
                        <div className='Working_process_details_discription4'>
                            Tactics That Can Help Your Business Grow.
                            <div className='Working_process_details_discription4_line'></div>
                        </div>
                        <div className='Working_process_details_discription5'>
                            The Socrol of Successful Business.
                            <div className='Working_process_details_discription4_line'></div>
                        </div>
                        <div className='Working_process_details_discription6'>
                            How To Stan A Business With Buckness.
                            <div className='Working_process_details_discription4_line'></div>
                        </div>

                        <button className='Working_process_details_btn'> See how it works</button>
                    </div>
